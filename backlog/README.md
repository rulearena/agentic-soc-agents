...
| Purple Team | [purple-team.md](purple-team.md) | 4 | 8 | `purple-team-adversary-emulator`, `purple-team-detection-validator` |
| **合計** | — | **35 active** | **45 resolved** | 14 個 agent（total corpus 80）|
