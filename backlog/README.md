...
| Threat Intel | [threat-intel.md](threat-intel.md) | 4 | 6 | 1 | `threat-intel-analyst`, `threat-intel-ioc-curator` |
...
| **合計** | — | **25 active** | **51 resolved** | **4 dropped** | 14 個 agent（total corpus 80）|
