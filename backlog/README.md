...
| Incident Response | [incident-response.md](incident-response.md) | 2 | 13 | 1 | `incident-response-ir-commander`, `incident-response-forensics-analyst`, `incident-response-ir-analyst` |
...
| **合計** | — | **14 active** | **61 resolved** | **5 dropped** | 14 個 agent（total corpus 80）|
