...
|---|---|---|---|---|
| Triage | [triage.md](triage.md) | 6 | 6 | `triage-l1-soc-analyst`, `triage-l2-soc-analyst` |
...
| Purple Team | [purple-team.md](purple-team.md) | 6 | 6 | `purple-team-adversary-emulator`, `purple-team-detection-validator` |
| **合計** | — | **41 active** | **39 resolved** | 14 個 agent（total corpus 80）|
