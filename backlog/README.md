...
| Incident Response | [incident-response.md](incident-response.md) | 5 | 10 | 1 | `incident-response-ir-commander`, `incident-response-forensics-analyst`, `incident-response-ir-analyst` |
...
| **合計** | — | **17 active** | **58 resolved** | **5 dropped** | 14 個 agent（total corpus 80）|
