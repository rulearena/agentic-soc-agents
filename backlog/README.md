...
| Threat Intel | [threat-intel.md](threat-intel.md) | 3 | 7 | 1 | `threat-intel-analyst`, `threat-intel-ioc-curator` |
...
| **合計** | — | **24 active** | **52 resolved** | **4 dropped** | 14 個 agent（total corpus 80）|
