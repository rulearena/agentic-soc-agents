...
|---|---|---|---|---|
| Triage | [triage.md](triage.md) | 12 | 0 | `triage-l1-soc-analyst`, `triage-l2-soc-analyst` |
| Incident Response | [incident-response.md](incident-response.md) | 16 | 0 | `incident-response-ir-commander`, `incident-response-forensics-analyst`, `incident-response-ir-analyst` |
...
| Governance | [governance.md](governance.md) | 17 | 1 | `governance-soc-manager`, `governance-compliance-auditor`, `governance-audit-liaison` |
| Purple Team | [purple-team.md](purple-team.md) | 11 | 1 | `purple-team-adversary-emulator`, `purple-team-detection-validator` |
| **合計** | — | **78 active** | **2 resolved** | 14 個 agent（total corpus 80）|
