...
| Purple Team | [purple-team.md](purple-team.md) | 3 | 9 | `purple-team-adversary-emulator`, `purple-team-detection-validator` |
| **合計** | — | **32 active** | **48 resolved** | 14 個 agent（total corpus 80）|
