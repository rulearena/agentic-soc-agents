...
| Incident Response | [incident-response.md](incident-response.md) | 9 | 7 | `incident-response-ir-commander`, `incident-response-forensics-analyst`, `incident-response-ir-analyst` |
...
| **合計** | — | **44 active** | **36 resolved** | 14 個 agent（total corpus 80）|
