...
| Incident Response | [incident-response.md](incident-response.md) | 1 | 14 | 1 | `incident-response-ir-commander`, `incident-response-forensics-analyst`, `incident-response-ir-analyst` |
...
| **合計** | — | **13 active** | **62 resolved** | **5 dropped** | 14 個 agent（total corpus 80）|
