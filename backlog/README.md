...
| Incident Response | [incident-response.md](incident-response.md) | 3 | 12 | 1 | `incident-response-ir-commander`, `incident-response-forensics-analyst`, `incident-response-ir-analyst` |
...
| **合計** | — | **15 active** | **60 resolved** | **5 dropped** | 14 個 agent（total corpus 80）|
