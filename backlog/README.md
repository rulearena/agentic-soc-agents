...
| Purple Team | [purple-team.md](purple-team.md) | 1 | 11 | 0 | `purple-team-adversary-emulator`, `purple-team-detection-validator` |
| **合計** | — | **9 active** | **66 resolved** | **5 dropped** | 14 個 agent（total corpus 80）|
