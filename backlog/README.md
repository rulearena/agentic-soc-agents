...
|---|---|---|---|---|---|
| Triage | [triage.md](triage.md) | 2 | 10 | 0 | `triage-l1-soc-analyst`, `triage-l2-soc-analyst` |
| Incident Response | [incident-response.md](incident-response.md) | 4 | 11 | 1 | `incident-response-ir-commander`, `incident-response-forensics-analyst`, `incident-response-ir-analyst` |
...
| **合計** | — | **16 active** | **59 resolved** | **5 dropped** | 14 個 agent（total corpus 80）|
