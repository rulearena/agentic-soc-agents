...
| Category | 檔案 | 條目數 | 對應 agent 檔名 stem |
|---|---|---|---|
| Triage | [triage.md](triage.md) | 12 | `triage-l1-soc-analyst`, `triage-l2-soc-analyst` |
| Incident Response | [incident-response.md](incident-response.md) | 16 | `incident-response-ir-commander`, `incident-response-forensics-analyst`, `incident-response-ir-analyst` |
| Detection Engineering | [detection-engineering.md](detection-engineering.md) | 11 | `detection-engineering-threat-detection-engineer`, `detection-engineering-threat-hunter` |
| Threat Intel | [threat-intel.md](threat-intel.md) | 11 | `threat-intel-analyst`, `threat-intel-ioc-curator` |
| Governance | [governance.md](governance.md) | 18 | `governance-soc-manager`, `governance-compliance-auditor`, `governance-audit-liaison` |
