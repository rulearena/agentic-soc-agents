...
> **v1.1 狀態**：下列 4 themes 的 representative P1 controls 已 shipped（故標 🔵 in progress）。各 theme 的 remaining 條目（P2 / attribution family / cross-role 整合）為 **candidate，非 commitment**——🔵 表示「代表性控制已進 main」，不表示整個 theme 已完工。完整 tactical 狀態見 [`backlog/triage-v1.1.md`](backlog/triage-v1.1.md)。
