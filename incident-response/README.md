...
- ✅ [`incident-response-forensics-analyst`](incident-response-forensics-analyst.md) — Forensic-grade evidence acquisition、chain of custody、artifact analysis、preservation gating
